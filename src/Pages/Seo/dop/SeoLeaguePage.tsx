...
import { CreateLeagueSeo } from "../../../modules/Forms/seo-form/create";
import { useTypeSelector } from "../../../hooks/useTypeSelector";
import { useTypeDispatch } from "../../../hooks/useTypeDispatch";
import { fetchAllSeo } from "../../../store/Slices/seoSlice/asyncActions";
import { EnumStatus } from "../../../types/Status";

export const SeoLeaguePage: FC = () => {
  ...
  useEffect(() => {
    dispatch(fetchAllSeo({ sportId: sportId, country: false }));
  }, [sportId]);

  return (
    <div className="form">
      <div className="flex items-center mb-5">
        <h1>Редактировать Seo для Лиг</h1>
        <Button
          onClick={onModalOpen}
          type="primary"
